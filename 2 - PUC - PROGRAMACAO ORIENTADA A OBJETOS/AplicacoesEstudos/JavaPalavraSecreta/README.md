...
![GitHub last commit](https://img.shields.io/github/last-commit/gleberphant/JavaPalavraSecreta)
![GitHub branch status](https://img.shields.io/github/checks-status/gleberphant/JavaPalavraSecreta/master)
![GitHub License](https://img.shields.io/github/license/gleberphant/JavaPalavraSecreta)
...
Gostou do projeto? Considere fazer uma doação para ajudar a melhorá-lo!
...
Jogo da Palavra Secreta Feito em JAVA.
...
Execute a classe App.Main para jogar.
...
```
git clone https://github.com/gleberphant/JavaPalavraSecreta.git
```
