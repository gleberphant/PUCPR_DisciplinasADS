...
![SQL BADGE](    https://img.shields.io/badge/SQL-14354C?style=for-the-badge&logo=python&logoColor=white)
...
Conteudo para a disciplina de `ESTATÍSTICA`, do curso de Análise e Desenvolvimento de Sistemas da PUC PR. 
...
```
git clone https://github.com/gleberphant/estatística_ADS_PUCPR.git
```
